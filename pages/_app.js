    ...
    const web3Modal = new Web3Modal({
      ...
      providerOptions: {
        walletconnect: {
          ...
          options: {
            infuraId: "a8b2f76c55c04a568eb97c469f8a82db",
          },
        },
      },
    });
      ...
      <nav className={nav}>
          ...
          <Link href="/">
            <a>
              <div className={titleContainer}>
                <h2 className={title}>FIR registry</h2>
                <p className={description}>system</p>
              </div>
            </a>
          </Link>
          {!account && (
        ...
        <div className={linkContainer}>
          ...
          </Link>
          {
            ...
            /* show the nav link to create a new Complaint */
            account === ownerAddress && (
              <Link href="/create-fir">
                <a className={link}>File FIR</a>
              </Link>
            )
          }
        </div>
